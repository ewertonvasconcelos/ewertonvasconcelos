...
Atualmente cursando **Gestão de TI na Estácio**, foco minha carreira na interseção entre infraestrutura robusta e inteligência de dados. Com mais de 12 anos de experiência técnica, dediquei grande parte da minha trajetória ao suporte de missão e governança tecnológica.

---

### 📊 Do Suporte à Inteligência de Dados
Minha transição para **Business Intelligence** é sustentada por uma base sólida em:
...
* **Visão Analítica:** Transformação de logs técnicos e dados de infraestrutura em dashboards de decisão.
...
* **Sistemas:** Fedora KDE, Windows Server.
* **Dados & BI:** Lógica de extração de dados (ETL), monitoramento de logs, Power BI (em desenvolvimento).
* **Serviços:** Active Directory, DNS Automation, PJe-Calc (Suporte Técnico).
